...
class LoginPageFragment : Fragment() {
    ...
    override fun onResume() {
        ...
        btn_login.setOnClickListener {
            if(Login_Validation() == true){
                val current_customer : Customers = mainviewmodel.Login_Customer(login_emailId.text.toString())[0]
    ...
    fun Login_Validation() : Boolean {
        ...
        {
            Toast.makeText(MainApplication_Java.getContext(),"Enter a valid Email address",Toast.LENGTH_SHORT).show()
            return false
        }
